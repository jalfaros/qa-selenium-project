...
describe('Pruebas automatizadas new topic', () => {
    ...
    it('CP-31: Funcionalidad en el módulo de new topic', async () => {
        ...
        await sleep(4000)  
        await driver.findElement(By.id('reply-title')).sendKeys("Ejemplo Título NuevoTest200");
        try {
        ...
        expect(pageTitle).to.equal('Ejemplo Título NuevoTest200 - Staff - Discourse');
    });
    ...
    //     await driver.findElement(By.id('reply-title')).clear();
    //     await sleep(4000)  
    //     await driver.findElement(By.id('reply-title')).sendKeys("Ejemplo Título NuevoTest201");
    //     await sleep(1000)
    //     await driver.findElement(By.className('d-editor-input ember-text-area ember-view')).clear();
    //     await sleep(1000)
    //     await driver.findElement(By.xpath("//span[text()='Create Topic']")).click();
    ...
    //     await driver.findElement(By.id('reply-title')).clear();
    //     await sleep(3000)  
    //     await driver.findElement(By.id('reply-title')).sendKeys("Ejemplo Título NuevoTest300");
    //     await driver.findElement(By.className('d-editor-input ember-text-area ember-view')).sendKeys("prueba para el apartado post");
    //     await sleep(500)
    //     await driver.findElement(By.xpath("//span[text()='Create Topic']")).click();
    //     await driver.wait(until.titleContains('Ejemplo Título NuevoTest'));
    //     let pageTitle = await driver.getTitle();
    //     expect(pageTitle).to.contains('Ejemplo Título NuevoTest300 - Discourse');
    // });
