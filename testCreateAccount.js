...
describe('Prueba en crear categoría, funcionalidad en el módulo de new Category', () => {
    ...
    beforeEach(async () => {
        ...
        await driver.findElement(By.id('login-account-name')).sendKeys("MarcoTest");
        await driver.findElement(By.id('login-account-password')).sendKeys("9rwMh7XiVmcA");
        await driver.findElement(By.id("login-button")).click();

        await sleep(2000);

        await driver.get("http://192.168.0.113/new-category");
    });
